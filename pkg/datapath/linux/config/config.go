...
func (h *HeaderfileWriter) WriteNodeConfig(w io.Writer, cfg *datapath.LocalNodeConfiguration) error {
	...
	cDefinesMap["LB6_REVERSE_NAT_MAP_V2"] = "cilium_lb6_reverse_nat_v2"
	...
	cDefinesMap["LB4_REVERSE_NAT_MAP_V2"] = "cilium_lb4_reverse_nat_v2"
	cDefinesMap["LB4_SERVICES_MAP_V3"] = "cilium_lb4_services_v3"
